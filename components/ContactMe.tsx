    ...
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-7 md:space-y-10 ">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-primary py-3 px-8 md:py-5 md:px-10 rounded-full text-secondary font-bold text-lg hover:ring-2 hover:ring-primary hover:bg-secondary hover:text-primary transition-all duration-200 ease-in-out"
          >
            Submit
          </button>
        </form>
